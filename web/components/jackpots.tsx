...
const Jackpots = ({ jackpots }: { jackpots: any[]}) => {
  return (
  ...
  return (
    <div className="w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-2 px-3 py-5">
      <div className="flex justify-start items-center space-x-2">
        ...
        />
        <div>
          <p className="text-green-300">Upto: {Number(jackpot.ticketPrice)} ETH</p>
          <p className="text-sm text-gray-500">Draws On: {new Date(Number(jackpot.expiresAt)).toString()}</p>
        </div>
      </div>
      <div className="py-5">
